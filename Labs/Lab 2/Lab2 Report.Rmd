...
It is evident that 95% equal tail posterior probability intervals do not contain most data points. It should not contain most data points because the interval illustrates uncertainty around the median value.
...
The approximate 95% equal tail posterior probability interval for the regression coefficient to the variable *NSmallChild* is given by the expression, $[E(\theta|y) - 1.96 \cdot SD(\theta|y),E(\theta|y) + 1.96 \cdot SD(\theta|y)]$.
